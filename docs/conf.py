...
htmlhelp_basename = 'MauthAuthenticatorforRequestsdoc'
...
man_pages = [
    (master_doc, 'mauthauthenticatorforrequests', 'Mauth Authenticator for Requests Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MauthAuthenticatorforRequests', 'Mauth Authenticator for Requests Documentation',
     author, 'MauthAuthenticatorforRequests', 'One line description of project.',
     'Miscellaneous'),
]
